...
The API and other aspects of the system are documented on [GitHub Pages](https://hwinther.github.io/ClutterStock/) — OpenAPI / ReDoc at the site root, the [database schema (SchemaSpy)](https://hwinther.github.io/ClutterStock/database/) under `/database/`, [project Markdown docs](https://hwinther.github.io/ClutterStock/project-docs/) under `/project-docs/`, and test coverage under [`/coverage-dotnet/`](https://hwinther.github.io/ClutterStock/coverage-dotnet/) and [`/coverage-node/`](https://hwinther.github.io/ClutterStock/coverage-node/).
