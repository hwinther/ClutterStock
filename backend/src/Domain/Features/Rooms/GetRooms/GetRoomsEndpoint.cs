...
public class GetRoomsEndpoint : IEndpoint
{
    ...
    public static Delegate Handler => (Func<IGetRoomsQueryHandler, CancellationToken, Task<IResult>>) Handle;

    private static async Task<IResult> Handle(IGetRoomsQueryHandler handler,
