...
public class AddLocationEndpoint : IEndpoint
{
    ...
    public static Delegate Handler => (Func<IAddLocationCommandHandler.Command, IAddLocationCommandHandler, CancellationToken, Task<IResult>>) Handle;

    private static async Task<IResult> Handle([FromBody] IAddLocationCommandHandler.Command command,
