...
public class GetLocationsEndpoint : IEndpoint
{
    ...
    public static Delegate Handler => (Func<IGetLocationsQueryHandler, CancellationToken, Task<IResult>>) Handle;

    private static async Task<IResult> Handle(IGetLocationsQueryHandler handler,
