...
public sealed class EndpointRegistrationGenerator : IIncrementalGenerator
{
        ...
        context.RegisterSourceOutput(
            ...
            static (productionContext, compilation) =>
            {
                try
                {
                    ...
                    var source = GenerateEndpointRegistration(endpointTypes, httpMethodAttribute);
    ...
    private static string GenerateEndpointRegistration(ImmutableArray<INamedTypeSymbol> endpointTypes, INamedTypeSymbol? httpMethodAttributeType)
    {
