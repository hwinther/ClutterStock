...
public sealed class HandlerRegistrationGenerator : IIncrementalGenerator
{
    ...
    private static ImmutableArray<(INamedTypeSymbol Interface, INamedTypeSymbol Implementation)> GetHandlerRegistrations(Compilation compilation,
    ...
    private static string GenerateHandlerRegistration(ImmutableArray<(INamedTypeSymbol Interface, INamedTypeSymbol Implementation)> registrations)
    {
        ...
        {
            var ifaceName = handlerInterface.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat)
                                            .Replace("global::", "");
